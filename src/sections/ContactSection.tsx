...
import { SocialMediaContext } from "@/hooks/contents/SocialMediaContext";

const ContactSection = () => {
   const infoContato = useContext(ContactContext);
   
   const redesSociais = useContext(SocialMediaContext);     

   return (
      <section
         className="section-spacing flex items-center justify-center min-h-screen py-12"
      >
         <div className="container mx-auto px-6" id="contato" >
            <div className="text-center mb-16">
               <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                  Formas de Contato
               </h2>
               <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Pronto para transformar suas ideias em realidade? Entre em
                  contato e vamos conversar sobre seu próximo projeto
               </p>
            </div>

            <div className="grid lg:grid-cols-1 max-w-6xl mx-auto">
